...
<head>
  ...
  <title>Sistem Manajement siswa</title>
...
<body class="hold-transition login-page" style="background-image: url('{{ asset("img/wallup.jpg") }}'); background-size: cover; background-attachment: fixed;">
  <div class="login-box">
    <div class="login-logo">
      <img src="{{ asset('img/favicon.png') }}" width="50%" alt="">
    </div>
    ...
    <footer style="color: white;">
      <marquee>
          <strong>K7 &copy; <script>document.write(new Date().getFullYear());</script> &diams; <a style="color: white;">SMK NIGGAS</a>. </strong>
      </marquee>
    </footer>
  </div>
...
@error('id_card')
  <script>
    toastr.error("Maaf User ini tidak terdaftar sebagai Guru SMK NIGGAS ! ");
  </script>
@enderror
@error('guru')
  <script>
...
@error('no_induk')
  <script>
    toastr.error("Maaf User ini tidak terdaftar sebagai Siswa SMK NIGGAS !");
  </script>
@enderror
@error('siswa')
  <script>
